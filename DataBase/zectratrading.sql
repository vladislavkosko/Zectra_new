...
-- Дамп данных таблицы zectratrading_com.offices: ~6 rows (приблизительно)
...
INSERT INTO `offices` (`id`, `owner_id`, `name`, `description`) VALUES
	...
	(6, 3, 'Office 6', 'Test Adding Office'),
...
-- Дамп данных таблицы zectratrading_com.office_posts: ~20 rows (приблизительно)
...
CREATE TABLE IF NOT EXISTS `office_roles` (
  ...
  KEY `IDX_BF658D47A76ED395` (`user_id`),
  CONSTRAINT `FK_BF658D47A76ED395` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
...
-- Дамп данных таблицы zectratrading_com.project_posts: ~5 rows (приблизительно)
...
-- Дамп данных таблицы zectratrading_com.sprints: ~0 rows (приблизительно)
...
-- Дамп данных таблицы zectratrading_com.sprint_statuses: ~0 rows (приблизительно)
...
-- Дамп данных таблицы zectratrading_com.tasks: ~0 rows (приблизительно)
...
-- Дамп данных таблицы zectratrading_com.user_role: ~4 rows (приблизительно)
