$(function() {
    ...
    var ul = $('#upload_ofice ul');
    console.log('script_ofice.js was loadded');
    ...
    $('#drop_upload_ofice a').click(function(){
    ...
    $('#upload_ofice').fileupload_ofice({

        // This element will accept file drag/drop uploading
        dropZone: $('#drop_upload_ofice'),
